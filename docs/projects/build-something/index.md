---
description: Project challenges with a defined scope, sorted by difficulty.
---
...
-   :material-numeric-1-box:{ .lg .middle } __Beginner__

    ---

    You know loops, functions and lists. You haven't built anything with more
    than one file.

    [:octicons-arrow-right-24: Beginner challenges](beginner.md)

-   :material-numeric-2-box:{ .lg .middle } __Intermediate__

    ---

    You've finished something. Now you want it to have structure, tests and an
    interface someone else could use.

    [:octicons-arrow-right-24: Intermediate challenges](intermediate.md)
...
|-------|------------------|
| [python-beginner-projects](https://github.com/MrinankBhowmick/python-beginner-projects) | Dozens of small project ideas with source. Read the idea, close the tab, then write it yourself |
| [discord.py masterclass](https://github.com/FallenDeity/discord.py-masterclass) | A full guide to building a Discord bot, which is how a lot of people here started |
| [Eos](../our-projects/eos.md) | Our own bot. Real issues, real review, and contributions are welcome |
