...
A good question gets answered in minutes. A bad one sits there while people read
it, sigh, and scroll past. Laziness is not a virtue.
...
Not the last line. The whole thing, from `Traceback (most recent call last)`
down. The useful information is usually in the middle.
