---
description: The rules for the Practical Python Discord, in full.
---

# Rules

Seven rules. Read them once and you'll be fine.

| # | Rule | Short version |
|---|------|---------------|
| 1 | [Be kind and respectful](#1-be-kind-and-respectful) | Treat others how you'd like to be treated |
| 2 | [Stay on topic](#2-stay-on-topic) | Post in the channel that fits |
| 3 | [Share responsibly](#3-share-responsibly) | Source code, never an `.exe` |
| 4 | [Ethical coding only](#4-ethical-coding-only) | White hat, and say what you're doing |
| 5 | [Moderators have final say](#5-moderators-have-final-say) | Their call ends the dispute |
| 6 | [No jobs or employment advertising](#6-no-jobs-or-employment-advertising) | Use a real job board |
| 7 | [Ask effective questions](#7-ask-effective-questions) | Code, error, and what you tried |
